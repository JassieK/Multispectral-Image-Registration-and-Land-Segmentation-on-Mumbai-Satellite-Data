...
multispectral_img = cv2.imread('D:/IMAGEE SEG/Registered imgs/4j/4j_Reg_Multi.jpg')

# Load the panchromatic image
panchromatic_img = cv2.imread('D:/IMAGEE SEG/Registered imgs/4j/4j_Reg_pan.jpg')
...
plt.imsave('D:/IMAGEE SEG/Registered imgs/4j/4j_fused.jpg',fused_rgb )
